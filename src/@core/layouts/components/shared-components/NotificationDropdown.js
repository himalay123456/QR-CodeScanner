        ...
        <ScrollWrapper>
          <MenuItem onClick={handleDropdownClose}>
            <Box sx={{ width: '100%', display: 'flex', alignItems: 'center' }}>
              ...
              <Avatar sx={{ color: 'common.white', backgroundColor: 'primary.main' }}>A1</Avatar>
              <Box sx={{ mx: 4, flex: '1 1', display: 'flex', overflow: 'hidden', flexDirection: 'column' }}>
                <MenuItemTitle>Ongoing case status updated!</MenuItemTitle>
                <MenuItemSubtitle variant='body2'>Admin1 have updated the status of Case5 to pending.</MenuItemSubtitle>
              </Box>
          ...
          <MenuItem onClick={handleDropdownClose}>
            <Box sx={{ width: '100%', display: 'flex', alignItems: 'center' }}>
              {/* <Avatar alt='Flora' src='/images/avatars/4.png' /> */}
              <Avatar sx={{ color: 'common.white', backgroundColor: 'primary.main' }}>C4</Avatar>
              <Box sx={{ mx: 4, flex: '1 1', display: 'flex', overflow: 'hidden', flexDirection: 'column' }}>
                <MenuItemTitle>Client4 added comment!</MenuItemTitle>
                <MenuItemSubtitle variant='body2'>Client4 have addded some some in Case2.</MenuItemSubtitle>
              </Box>
              <Typography variant='caption' sx={{ color: 'text.disabled' }}>
                Today
              </Typography>
