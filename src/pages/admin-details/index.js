...
const AdminDetails = () => {
  ...
  return (
    <Card>
      <CardHeader title='Admin Details' titleTypographyProps={{ variant: 'h6' }} />
      <Divider sx={{ margin: 0 }} />
      <form onSubmit={e => e.preventDefault()}>
        <CardContent>
          ...
          <ConfirmationModal
            ...
            subtitle='Once the admin is disabled they may no longer be able to access the website. Are you sure you want to disable this admin?'
